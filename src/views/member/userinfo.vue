...
<!--                                            <button class="btn_blue_1" style="border:none;" @click="getUserInfo()">确认修改</button>-->
                                          <span name="submit" type="submit" value="确认修改" @click="confirmModify()" class="btn_blue_1" style="border:none;">确认修改</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
